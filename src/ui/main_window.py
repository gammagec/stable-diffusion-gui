...
class MainWindow:
	...
	def __init__(self, app_context):
		...
		sessions_view = SessionsView(layout.left, app_context.sessions_model)
		sessions_view.update_sessions()
		...
		params_view = ParamsView(layout.right, app_context.params_model, ParamsViewModel(app_context.params_model, app_context))		
		params_view.create()
